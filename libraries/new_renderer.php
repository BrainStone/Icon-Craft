<?php
  class Renderer {
    ...
    private function translate_coordinates(&$coordinates) {
      ...
      $coordinates[0] = (sin($camera->yaw)*sin($camera->pitch)*sin($camera->roll)+cos($camera->yaw)*cos($camera->roll))*$coordinates[0]
      ...
      $coordinates[1] = cos($camera->pitch)*sin($camera->roll)*$coordinates[0]
        + cos($camera->pitch)*cos($camera->roll)*$coordinates[1]
        - sin($camera->pitch)*$coordinates[2];
      $coordinates[2] = (cos($camera->yaw)*sin($camera->pitch)*sin($camera->roll)-sin($camera->yaw)*cos($camera->roll))*$coordinates[0]
        + (cos($camera->yaw)*sin($camera->pitch)*cos($camera->roll)+sin($camera->yaw)*sin($camera->roll))*$coordinates[1]
        + cos($camera->yaw)*cos($camera->pitch)*$coordinates[2];

      /*$coordinates[0] = (sin($camera->yaw)*sin($camera->pitch)*sin($camera->roll)+cos($camera->yaw)*cos($camera->roll))*$coordinates[0]
        + cos($camera->pitch)*sin($camera->roll)*$coordinates[1]
        + (cos($camera->yaw)*sin($camera->pitch)*sin($camera->roll)-sin($camera->yaw)*cos($camera->roll))*$coordinates[2];
      $coordinates[1] = (sin($camera->yaw)*sin($camera->pitch)*cos($camera->roll)-cos($camera->yaw)*sin($camera->roll))*$coordinates[0]
        + cos($camera->pitch)*cos($camera->roll)*$coordinates[1]
        + (cos($camera->yaw)*sin($camera->pitch)*cos($camera->roll)+sin($camera->yaw)*sin($camera->roll))*$coordinates[2];
      $coordinates[2] = sin($camera->yaw)*cos($camera->pitch)*$coordinates[0]
        - sin($camera->pitch)*$coordinates[1]
        + cos($camera->yaw)*cos($camera->pitch)*$coordinates[2];*/
